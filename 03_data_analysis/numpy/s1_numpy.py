...
np.arrange(1,10,2)                      # returns an array consisting of numbers (1) to (10) with the step of (2)
...
np.arange(10,70,2)                      # e.g.: making a plots x-axis have labels with a certain start point, end point and step
...
random.rand(3,2)                        # gives a matrix 8x5 of numbers between 0 and 1
random.choice(np.array([1,3,5,9]), size=(3,2))      # the size kw argument is optional
