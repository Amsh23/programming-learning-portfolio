...
turtle.title("ROCK PAPAER SCISSORS") 
 
rectangle(650,100,-320,310) 
goto(0,240) 
turtle.write("  ROCK  PAPAER  SCISSORS  ",align='center',font=("tahoma",30,"bold")) 
...
while True: 
    ...
    turtle.home() 
    turtle.pendown()   
    if (vorodi=="r" and rand=="scissors" )or (vorodi=="s" and rand=="paper") or (vorodi=="p" and rand=="rock"):
        you+=1
    elif vorodi==rand:
        pass
    elif (rand=="rock" and vorodi=="s" )or (rand=="scissors" and vorodi=="p") or (rand=="paper" and vorodi=="r"):
        system+=1
    else:
        pass
    rectangle(325,60,-320,150) 
